...
# head(da3)
plot(da3$km.min ~ da3$DT, type = 'l', main = "Route 1")
da3 <- subset(da, subset = da[, 3] == 6 & da[,13] =="")
# head(da3)
plot(da3$km.min ~ da3$DT, type = 'l', main = "Route 6")
da3 <- subset(da, subset = da[,13] !="")
# head(da3)
plot(da3$km.min ~ da3$DT, type = 'l', main = "All notes")
da3 <- subset(da, subset = da[1:15 ,3] == 1)
# head(da3)
plot(da3$km.min ~ da3$DT, type = 'l', main = "Recent 1")
da3 <- subset(da, subset = da[1:15 ,3] == 6)
# head(da3)
plot(da3$km.min ~ da3$DT, type = 'l', main = "Recent 6")
da3 <- subset(da, subset = da[,3] == "6A")
#da3
plot(da3$km.min ~ da3$DT, type = 'l', main = "Route 6A")
```
